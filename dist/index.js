...
const uri = 'mongodb+srv://dylanreeder5:Password12@cluster0.vklcs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
const clientOptions = {
...
app.post('/sms', async (req, res) => {
    ...
    await User.findOneAndUpdate({ id: From }, { $push: { responses: response.content } });
